...
(document.getElementById('NazMgr').innerHTML) = (document.getElementById('NazMg').value) ;
(document.getElementById('ArtMgr').innerHTML) = (document.getElementById('ArtMg').value) ;
(document.getElementById('NazKr').innerHTML) = (document.getElementById('NazK').value) ;
(document.getElementById('ArtKr').innerHTML) = (document.getElementById('ArtK').value) ;
(document.getElementById('NazKfr').innerHTML) = (document.getElementById('NazKf').value) ;
(document.getElementById('ArtKfr').innerHTML) = (document.getElementById('ArtKf').value) ;
(document.getElementById('NazFer').innerHTML) = (document.getElementById('NazFe').value) ;
(document.getElementById('ArtFer').innerHTML) = (document.getElementById('ArtFe').value) ;
(document.getElementById('NazMnr').innerHTML) = (document.getElementById('NazMn').value) ;
(document.getElementById('ArtMnr').innerHTML) = (document.getElementById('ArtMn').value) ;
(document.getElementById('NazBrr').innerHTML) = (document.getElementById('NazB').value) ;
(document.getElementById('ArtBrr').innerHTML) = (document.getElementById('ArtB').value) ;
(document.getElementById('NazZnr').innerHTML) = (document.getElementById('NazZn').value) ;
(document.getElementById('ArtZnr').innerHTML) = (document.getElementById('ArtZn').value) ;
(document.getElementById('NazCur').innerHTML) = (document.getElementById('NazCu').value) ;
(document.getElementById('ArtCur').innerHTML) = (document.getElementById('ArtCu').value) ;
(document.getElementById('NazMor').innerHTML) = (document.getElementById('NazMo').value) ;
(document.getElementById('ArtMor').innerHTML) = (document.getElementById('ArtMo').value) ;
(document.getElementById('NazKnr').innerHTML) = (document.getElementById('NazKn').value) ;
(document.getElementById('ArtKnr').innerHTML) = (document.getElementById('ArtKn').value) ;
(document.getElementById('NazCar').innerHTML) = (document.getElementById('NazCa').value) ;
(document.getElementById('ArtCar').innerHTML) = (document.getElementById('ArtCa').value) ;
(document.getElementById('NazAmr').innerHTML) = (document.getElementById('NazAm').value) ;
(document.getElementById('ArtAmr').innerHTML) = (document.getElementById('ArtAm').value) ;
...
var text = document.getElementById('NazMg').value + ' ' + Gramssohr1 + ' гр. ' ;
var text = document.getElementById('NazMg').value + ' ' + Gramssohr1 + ' гр. ' ;
text2 = document.getElementById('NazK').value + ' ' + Gramssohr2 + ' гр. ' ;
text3 = document.getElementById('NazKf').value + ' '	+ Gramssohr3 + ' гр. ' ;
text4 = document.getElementById('NazFe').value + ' ' + Gramssohr4 + ' гр. ' ;
text5 = document.getElementById('NazMn').value + ' ' + Gramssohr5 + ' гр. ' ;
text6 = document.getElementById('NazB').value + ' ' + Gramssohr6 + ' гр. ' ;
text7 = document.getElementById('NazB').value + ' ' + Gramssohr7 + ' гр. ' ;
text8 = document.getElementById('NazCu').value + ' ' + Gramssohr8 + ' гр. ' ;
text9 = document.getElementById('NazMo').value + ' ' + Gramssohr9 + ' гр. ' ;
text10 = document.getElementById('NazKn').value + ' ' + Gramssohr10 + ' гр. ' ;
text11 = document.getElementById('NazCa').value + ' ' + Gramssohr11 + ' гр. ' ;
text12 = document.getElementById('NazAm').value + ' ' + Gramssohr12 + ' гр. ' ;
